...
!function(t, e) {
    ...
    function ft(t, e) {
        ...
        if (s.enable) {
            ...
            case "min":
                o.value = o.min,
                t && (o.status = "increasing");
                break;
            case "max":
                o.value = o.max,
                t && (o.status = "decreasing");
                break;
            default:
                o.value = C(o),
                t && (o.status = _() >= .5 ? "increasing" : "decreasing")
            }
        }
    ...
    function kt(t) {
        for (const [, e] of Pt)
            if (t.startsWith(e.stringPrefix))
                return e.parseString(t);
    ...
    function Ot(t, e, i=!0) {
        ...
        if (wt(s.value))
            return s.value === Mt ? Bt() : Ft(s.value);
        if (zt(s.value))
            return Ot({
                value: K(s.value, e, i)
            });
    ...
    function Lt(t) {
        ...
        const a = (t, e, i) => (i < 0 && (i += 1), i > 1 && (i -= 1), 6 * i < 1 ? t + 6 * (e - t) * i : 2 * i < 1 ? e : 3 * i < 2 ? t + (e - t) * (2 / 3 - i) * 6 : t),
            r = n < .5 ? n * (1 + o) : n + o - n * o,
            c = 2 * n - r,
    ...
    function qt(t, e, i) {
            ...
            return i;
        {
            ...
            if (i && s && e)
                return $t(i, s, t.getRadius(), e.getRadius());
            {
                const t = i ?? s;
                if (t)
                    return Lt(t)
    ...
    function Wt(t, e, i) {
        t.enable = e.enable,
        t.enable ? (t.velocity = P(e.speed) / 100 * i, t.decay = 1 - P(e.decay), t.status = "increasing", t.loops = 0, t.maxLoops = P(e.count), t.time = 0, t.delayTime = 1e3 * P(e.delay), e.sync || (t.velocity *= _(), t.value *= _()), t.initialValue = t.value) : t.velocity = 0
    }
    function Nt(t, e, i) {
        t.beginPath(),
        t.moveTo(e.x, e.y),
    ...
    function Qt(t) {
        const {container: e, context: i, particle: s, delta: o, colorStyles: n, backgroundMask: a, composite: r, radius: c, opacity: l, shadow: h, transform: d} = t,
            u = s.getPosition(),
        ...
        h.enable && y && (i.shadowBlur = h.blur, i.shadowColor = Vt(y), i.shadowOffsetX = h.offset.x, i.shadowOffsetY = h.offset.y),
    ...
    class ne {
        constructor(t)
        {
            ...
            this._getPluginParticleColors = t => {
                ...
                for (const s of this._colorPlugins)
                    if (!e && s.particleFillColor && (e = It(s.particleFillColor(t))), !i && s.particleStrokeColor && (i = It(s.particleStrokeColor(t))), e && i)
                        break;
                return [e, i]
            },
            this._initCover = () => {
        ...
        loadCanvas(t)
        {
            ...
            this._generated = t.dataset && i in t.dataset ? "true" === t.dataset[i] : this._generated,
            this.element = t,
        ...
        resize()
        {
            ...
            if (o === i.height && s === i.width && o === this.element.height && s === this.element.width)
                return !1;
            const n = {
                ...i
            };
    ...
    class re {
        constructor(t)
        {
            ...
            this._handleVisibilityChange = () => {
                ...
                e.pauseOnBlur && (document && document.hidden ? (t.pageHidden = !0, t.pause()) : (t.pageHidden = !1, t.getAnimationStatus() ? t.play(!0) : t.draw(!0)))
            },
            ...
            this._manageListeners = t => {
                const e = this._handlers,
                    ...
                    o = i.canvas.element;
                let r = n;
                "window" === s ? (i.interactivity.element = window, r = a) : i.interactivity.element = "parent" === s && o ? o.parentElement ?? o.parentNode : o,
    ...
    class Pe extends Ce {
        ...
        {
            super.load(t),
            t && (void 0 !== t.mode && (this.mode = t.mode), void 0 !== t.startValue && (this.startValue = t.startValue))
        }
    }
    class Se extends Ce {
        constructor()
    ...
    class Le {
        constructor()
        {
            this.horizontal = new Fe,
            this.vertical = new Fe
        }
        load(t)
        {
    ...
    class Xe {
        ...
        load(t)
        {
            ...
            void 0 !== t.distance && (this.distance = bt(t.distance) ? {
    ...
    class ni extends Ie {
        ...
        {
            super.load(t),
            t && (void 0 !== t.opacityRate && (this.opacityRate = t.opacityRate), void 0 !== t.sizeRate && (this.sizeRate = t.sizeRate), void 0 !== t.velocityRate && (this.velocityRate = t.velocityRate))
        }
    }
    class ai {
        constructor(t, e)
        ...
        load(t)
        {
            ...
            void 0 !== t.interactivity && (this.interactivity = st({}, t.interactivity));
            const e = t.stroke;
    ...
    class ui {
        ...
        init(t, e, i, s)
        {
            ...
            this.effect = ut(l, this.id, d),
            this.shape = ut(h, this.id, d);
            const u = c.effect,
                p = c.shape;
            if (i) {
            ...
            y.generator && (this.pathGenerator = this._engine.getPathGenerator(y.generator), this.pathGenerator && o.addPath(y.generator, this.pathGenerator) && this.pathGenerator.init(o)),
            ...
            w || (w = this._engine.getEffectDrawer(this.effect), w && o.effectDrawers.set(this.effect, w)),
            w && w.loadEffect && w.loadEffect(this);
            let b = o.shapeDrawers.get(this.shape);
            b || (b = this._engine.getShapeDrawer(this.shape), b && o.shapeDrawers.set(this.shape, b)),
            b && b.loadShape && b.loadShape(this);
            const x=b?.getSidesCount;
            x && (this.sides = x(this)),
            this.spawning = !1,
            this.shadowColor = Dt(this.options.shadow.color);
            for (const t of g.updaters)
                t.init(this);
            for (const t of g.movers)
                t.init && t.init(this);
    ...
    class yi {
        constructor(t, e)
        {
            ...
            this._subdivide = () => {
                const {x: t, y: e} = this.rectangle.position,
                    ...
                    {capacity: o} = this;
                for (let n = 0; n < 4; n++)
                    this._subs.push(new yi(new mi(t + .5 * i * (n % 2), e + .5 * s * (Math.round(.5 * n) - n % 2), .5 * i, .5 * s), o));
                this._divided = !0
            },
            this._points = [],
            this._divided = !1,
        ...
        query(t, e, i)
        {
            ...
            for (const i of this._points)
                !t.contains(i.position) && T(t.position, i.position) > i.particle.getRadius() && (!e || e(i.particle)) || s.push(i.particle);
            if (this._divided)
    ...
    const gi = t => {
        ...
        return new mi(-.25 * i, -.25 * e, 1.5 * i, 1.5 * e)
    };
    class wi {
        constructor(t, e)
        {
            ...
            this._applyDensity = (t, e, i) => {
                ...
                if (!t.number.density?.enable)
                    return void (void 0 === i ? this._limit = s.limit.value : s.limit && this._groupLimits.set(i, s.limit.value));
                ...
                void 0 === i ? this._limit = s.limit.value * o : this._groupLimits.set(i, s.limit.value * o),
                c < r ? this.push(Math.abs(r - c), void 0, t, i) : c > r && this.removeQuantity(c - r, i)
            },
        ...
        addManualParticles()
        {
            ...
            for (const i of e.manualParticles)
                this.addParticle(i.position ? vt(i.position, t.canvas.size) : void 0, i.options)
        }
        addParticle(t, e, i, s)
        {
        ...
        init()
        {
            ...
            for (const [, e] of t.plugins)
                if (void 0 !== e.particlesInitialization && (i = e.particlesInitialization()), i)
                    break;
            this._interactionManager.init();
            for (const [, e] of t.pathGenerators)
                e.init(t);
            if (this.addManualParticles(), !i) {
                ...
                for (const e in i) {
                    const s = i[e];
                    for (let i = this.count, o = 0; o<s.number?.value && i < t.number.value; i++, o++)
        ...
        async update(t)
        {
            ...
            for (const [, t] of e.pathGenerators)
                t.update();
            for (const [, i] of e.plugins)
                i.update && await i.update(t);
            const s = this._resizeFactor;
            for (const e of this._array) {
                s && !e.ignoresResizeRatio && (e.position.x *= s.width, e.position.y *= s.height, e.initialPosition.x *= s.width, e.initialPosition.y *= s.height),
                ...
                for (const i of this.movers)
                    i.isEnabled(e) && i.move(e, t);
    ...
    class bi {
        ...
        init()
        {
            const t = this.container,
                e = t.actualOptions;
            this.pixelRatio = !e.detectRetina || j() ? 1 : window.devicePixelRatio,
            this.reduceFactor = 1;
    ...
    class zi {
        constructor(t, e, i)
        {
            ...
            this._nextFrame = async t => {
                try {
                    if (!this._smooth && void 0 !== this._lastFrameTime && t < this._lastFrameTime + 1e3 / this.fpsLimit)
                    ...
                    if (this.addLifeTime(e.value), this._lastFrameTime = t, e.value > 1e3)
                        return void this.draw(!1);
            ...
            e.addEventListener("touchend", (t => {
                if (xi(this)) {
                    if (s && !o) {
                        ...
                        if (!s && (s = e.changedTouches[e.changedTouches.length - 1], !s))
                            return;
        ...
        destroy()
        {
            ...
            this.canvas.destroy();
            for (const [, t] of this.effectDrawers)
                t.destroy && t.destroy(this);
            for (const [, t] of this.shapeDrawers)
                t.destroy && t.destroy(this);
            for (const t of this.effectDrawers.keys())
                this.effectDrawers.delete(t);
            for (const t of this.shapeDrawers.keys())
                this.shapeDrawers.delete(t);
        ...
        async init()
        {
            ...
            this._options = _i(this._engine, this, this._initialSourceOptions, this.sourceOptions),
        ...
        {
            if (xi(this))
                return this._initialSourceOptions = void 0, this._options = _i(this._engine, this), this.actualOptions = _i(this._engine, this, this._options), this.refresh()
        }
        async start()
        {
    ...
    class Pi {
        ...
        {
            const t = {};
            for (const [e, i] of this._configs)
                t[e] = i;
            return t
        }
        get version()
        ...
        async load(t)
        {
            const e = t.id??t.element?.id ?? `tsparticles${Math.floor(1e4 * _())}`,
                {index: s, url: o} = t,
        ...
        setOnClickHandler(t)
        {
            const e = this.dom();
            if (!e.length)
                throw new Error(`${f} can only set click handlers after calling tsParticles.load()`);
            for (const i of e)
                i.addClickHandler(t)
        }
    }
    ...
    class Ii {
        ...
        set origin(t)
        {
            this.position.x = 100 * t.x,
            this.position.y = 100 * t.y
        }
        get particleCount()
        {
            return this.count
        ...
        load(t)
        {
            ...
            const s = t.position;
            s && (void 0 !== s.x && (this.position.x = s.x), void 0 !== s.y && (this.position.y = s.y)),
            void 0 !== t.colors && (zt(t.colors) ? this.colors = [...t.colors] : this.colors = t.colors);
            ...
            void 0 !== t.shapes && (zt(t.shapes) ? this.shapes = [...t.shapes] : this.shapes = t.shapes),
    ...
    function Ei(t, e, i, s, o, n) {
        ...
        a?.enable && i && (t.velocity.y += r * (a.acceleration * n.factor) / (60 * i));
        const c = t.moveDecay;
        t.velocity.multTo(c);
        ...
        const {position: u} = t;
        u.addTo(l),
        e.vibrate && (u.x += Math.sin(u.x * Math.cos(u.y)), u.y += Math.cos(u.y * Math.sin(u.x)))
    }
    class Ri {
        constructor()
        {
        ...
        move(t, e)
        {
            ...
            s.spin.enable ? function(t, e) {
                ...
                const o = Math.max(i.canvas.size.width, i.canvas.size.height),
                    n = .5 * o;
                t.spin.radius > n ? (t.spin.radius = n, t.spin.acceleration *= -1) : t.spin.radius < 0 && (t.spin.radius = 0, t.spin.acceleration *= -1),
                t.spin.angle += .01 * e * (1 - t.spin.radius / o)
            }(t, h) : Ei(t, s, h, d, c, e),
            function(t) {
                ...
                if (r || c)
                    if ((r && o >= r || c && n >= c) && !t.misplaced)
                        ...
                        r && (t.velocity.x = .5 * t.velocity.y - t.velocity.x),
                        c && (t.velocity.y = .5 * t.velocity.x - t.velocity.y);
                    else if ((!r || o < r) && (!c || n < c) && t.misplaced)
                        t.misplaced = !1;
                    else if (t.misplaced) {
                        const i = t.position,
                            s = t.velocity;
                        r && (i.x < e.x && s.x < 0 || i.x > e.x && s.x > 0) && (s.x *= -_()),
                        c && (i.y < e.y && s.y < 0 || i.y > e.y && s.y > 0) && (s.y *= -_())
                    }
            }(t)
        }
    }
    ...
    function Li(t, e, i, s, o) {
        if (!e || !i.enable || (e.maxLoops ?? 0) > 0 && (e.loops ?? 0) > (e.maxLoops ?? 0))
            return;
        if (e.time || (e.time = 0), (e.delayTime ?? 0) > 0 && e.time < (e.delayTime ?? 0) && (e.time += t.value), (e.delayTime ?? 0) > 0 && e.time < (e.delayTime ?? 0))
            return;
        const n = C(i.offset),
            a = (e.velocity ?? 0) * t.factor + 3.6 * n,
            r = e.decay ?? 1;
        o && "increasing" !== e.status ? (e.value -= a, e.value < 0 && (e.loops || (e.loops = 0), e.loops++, e.status = "increasing", e.value += e.value)) : (e.value += a, e.value > s && (e.loops || (e.loops = 0), e.loops++, o && (e.status = "decreasing", e.value -= e.value % s))),
    ...
    class Vi {
        ...
        update(t, e, i, s)
        {
            ...
            for (const [, s] of o.plugins)
                if (void 0 !== s.particleBounce && (n = s.particleBounce(t, i, e)), n)
                    break;
            if (n)
                return;
            ...
            case "inside":
                {
                    const {dx: e, dy: i} = O(t.position, t.moveCenter),
                        {x: s, y: o} = t.velocity;
                    if (s < 0 && e > t.moveCenter.radius || o < 0 && i > t.moveCenter.radius || s >= 0 && e < -t.moveCenter.radius || o >= 0 && i < -t.moveCenter.radius)
                        return;
                    break
                }
            }
    ...
    class $i {
        ...
        update(t, e, i, s)
        {
            ...
            if (o.enable) {
                ...
                if (t.velocity.y > 0 && t.position.y <= a.height + r || t.velocity.y < 0 && t.position.y >= -r || t.velocity.x > 0 && t.position.x <= a.width + r || t.velocity.x < 0 && t.position.x >= -r)
                    return;
            ...
            case "inside":
                {
                    ...
                    if (e <= 0 && n >= 0 || i <= 0 && a >= 0 || e >= 0 && n <= 0 || i >= 0 && a <= 0)
                        return;
                ...
                case "outside":
                    ...
                    }case "normal":
                    {
                        const i = t.options.move.warp,
                            ...
                            a = t.getRadius(),
                            r = it(t.position, a);
                        "right" === e && r.left > s.width + t.offset.x ? (t.position.x = n.left, t.initialPosition.x = t.position.x, i || (t.position.y = _() * s.height, t.initialPosition.y = t.position.y)) : "left" === e && r.right < -t.offset.x && (t.position.x = n.right, t.initialPosition.x = t.position.x, i || (t.position.y = _() * s.height, t.initialPosition.y = t.position.y)),
                        "bottom" === e && r.top > s.height + t.offset.y ? (i || (t.position.x = _() * s.width, t.initialPosition.x = t.position.x), t.position.y = n.top, t.initialPosition.y = t.position.y) : "top" === e && r.bottom < -t.offset.y && (i || (t.position.x = _() * s.width, t.initialPosition.x = t.position.x), t.position.y = n.bottom, t.initialPosition.y = t.position.y);
                        break
                    }
                }
            }
    ...
    function Wi(t, e) {
        if (!e.segments.length || !e.segments[0].values.length)
            return;
    ...
    class as {
        constructor(t, e, i, s, o)
        {
            ...
            this._destroy = () => {
                ...
                this._mutationObserver = void 0, this._resizeObserver?.disconnect(),
            ...
            s instanceof os ? this.options = s : (this.options = new os, this.options.load(s)),
            this._spawnDelay = 1e3 * P(this.options.life.delay ?? 0) / this.container.retina.reduceFactor,
            ...
            r && (this._shape = r.generate(this.position, this.size, this.fill, a.options)),
        ...
        resize()
        {
            ...
            this.position = t && tt(t, this.container.canvas.size, v.origin) ? t : this._calcPosition(),
            this._size = this._calcSize(),
            this.size = yt(this._size, this.container.canvas.size), this._shape?.resize(this.position, this.size)
        }
        async update(t)
        {
        ...
        async _emitParticles(t)
        {
            ...
            for (let i = 0; i < t; i++) {
                ...
                if (this.spawnColor) {
                    ...
                    e && (this.spawnColor.h = this._setColorAnimation(e.h, this.spawnColor.h, 360), this.spawnColor.s = this._setColorAnimation(e.s, this.spawnColor.s, 100), this.spawnColor.l = this._setColorAnimation(e.l, this.spawnColor.l, 100)),
                ...
                if (this._shape) {
                    ...
                    if (e) {
                        ...
                        o.opacity && (t.opacity ? t.opacity.value = e.opacity : t.opacity = {
                            value: e.opacity
                        })
                    } else
                        s = null
    ...
    class rs {
        constructor(t, e)
        {
            ...
            e.getEmitter = t => void 0 === t || bt(t) ? this.array[t || 0] : this.array.find((e => e.name === t)),
        ...
        case 44:
            await async function(t, e, i, s, o, n) {
                ...
                if (l) {
                            ...
                            for (let t = 0, e = 0; ;) {
                                ...
                                if (i = v(r, o), r += o + 1, i === m) {
                                    ...
                                    for (let s = 0; s < c[i].length; s++) {
                                        ...
                                        u.data.set([o, n, r, h], ms[l] * a.width + vs[l] * e + t % (4 * a.width)),
                                        t += 4
                                    }
                                    c.length === 1 << o && o < 12 && o++
                                }
                                if (t === 4 * a.width * (e + 1) && (e++, ms[l] + vs[l] * e >= a.height))
                                    break
                            }
                    ...
                    a.image = u,
                    a.bitmap = await createImageBitmap(u), n?.((t.pos + 1) / t.data.length, s(!1) + 1, a.image, {
                        x: a.left,
                        y: a.top
                    }, {
                        width: e.width,
        ...
        if ("gif" === t.type) {
            ...
            try {
                t.gifData = await async function(t, e, i) {
                    ...
                    n.width = a.nextTwoBytes(),
                    n.height = a.nextTwoBytes();
                    const r = a.nextByte(),
                        c = 128 == (128 & r);
                    n.colorRes = (112 & r) >>> 4,
                    n.sortFlag = 8 == (8 & r);
                    ...
                    try {
                        ...
                        if (t instanceof EvalError)
                            throw new Error(`error while parsing frame ${m} "${t.message}"`);
                        throw t
                    }
                }(t.source),
    ...
    async function zs(t) {
        if ("svg" !== t.type)
            return void await xs(t);
        t.loading = !0;
        const e = await fetch(t.source);
        e.ok ? t.svgData = await e.text() : (G().error(`${f} Image not found`), t.error = !0),
        t.loading = !1
    }
    function Ms(t, e, i, s) {
        ...
        draw(t)
        {
            ...
            if (a) {
                if (e.globalAlpha = o, a.gif && a.gifData) {
                    ...
                    if (void 0 === s.gifTime && (s.gifTime = 0), !l.bitmap)
                        return;
                    ...
                    case 2:
                        ...
                        e.drawImage(t, c.x, c.y),
                        o.clearRect(0, 0, t.width, t.height),
                        0 === a.gifData.globalColorTable.length ? o.putImageData(a.gifData.frames[0].image, c.x + l.left, c.y + l.top) : o.putImageData(a.gifData.backgroundImage, c.x, c.y);
                        break;
                    case 3:
                        {
    ...
    class Ws {
        ...
        init(t)
        {
            ...
            const s = e.animation;
            s.enable && (t.rotate.decay = 1 - P(s.decay), t.rotate.velocity = P(s.speed) / 360 * this.container.retina.reduceFactor, s.sync || (t.rotate.velocity *= _())),
    ...
    class Qs extends Ie {
        ...
        {
            super.load(t),
            t && (this.animation.load(t.animation), void 0 !== t.direction && (this.direction = t.direction), void 0 !== t.enable && (this.enable = t.enable))
        }
    }
    class Js {
        constructor(t)
        ...
        update(t, e)
        {
            this.isEnabled(t) && function(t, e) {
                ...
                const o = s.angleSpeed * e.factor,
                    n = s.moveSpeed * e.factor * ((t.retina.wobbleDistance ?? 0) * e.factor) / (1e3 / 60),
                    a = 2 * Math.PI,
                    {position: r} = t;
                s.angle += o,
                s.angle > a && (s.angle -= a),
    ...
    async function no(t) {
        if (!io) {
            ...
            await async function(t, e=!0) {
                ...
                t.addEmitterShapeGenerator || (t.addEmitterShapeGenerator = (e, i) => {
