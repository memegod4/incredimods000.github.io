        ...
        r = window._gsDefine.plugin({
            ...
            set: function(t) {
                ...
                var r = this._wdw || !this.skipX ? this.getX() : this.xPrev,
                    ...
                    n = s - this.yPrev,
                    a = r - this.xPrev;
                this._autoKill && (!this.skipX && (a > 7 || -7 > a) && i(this._target, "x") > r && (this.skipX = !0), !this.skipY && (n > 7 || -7 > n) && i(this._target, "y") > s && (this.skipY = !0), this.skipX && this.skipY && this._tween.kill()),
